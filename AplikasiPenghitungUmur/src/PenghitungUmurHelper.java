...
public class PenghitungUmurHelper {
    ...
    try {
        ...
        for (int i = 0; i < events.length(); i++) {
            ...
            // Coba terjemahkan, jika gagal gunakan teks asli
            String translatedDescription;
            try {
                translatedDescription = translateToIndonesian(description);
            } catch (Exception e) {
                translatedDescription = description + " (Gagal diterjemahkan)";
            }
